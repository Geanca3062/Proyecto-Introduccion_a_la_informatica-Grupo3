 ...
 * @author gean3
 */
public class GestionEventosBase extends javax.swing.JFrame {

    /**
     * Creates new form GestionEventos
     */
    public GestionEventosBase() {
        initComponents();
    }
    ...
    public static void main() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionEventosBase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionEventosBase().setVisible(true);
            }
        });
    }
